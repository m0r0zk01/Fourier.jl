...
gen_array('small_2d_5', (1, 8))
gen_array('small_2d_6', (8, 1))
gen_array('small_2d_7', (4, 16))
gen_array('small_2d_8', (16, 4))

gen_array('large_2d_1', (512, 512))
gen_array('large_2d_2', (2048, 2048))
gen_array('large_2d_3', (512, 16384))
gen_array('large_2d_4', (16384, 512))

gen_array('small_5d_1', (1, 1, 1, 1, 1))
gen_array('small_5d_2', (1, 2, 1, 2, 1))
gen_array('small_5d_3', (2, 2, 2, 2, 2))
gen_array('small_5d_4', (4, 4, 4, 4, 4))
gen_array('small_5d_5', (8, 8, 8, 8, 8))
