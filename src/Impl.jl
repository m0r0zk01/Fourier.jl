...
function _rev_k_bits(x::UInt64, k::Int)
    @fastmath begin
        ...
        x = ((x >> 08) & 0b0000000011111111000000001111111100000000111111110000000011111111) | ((x & 0b0000000011111111000000001111111100000000111111110000000011111111) << 08)
        x = ((x >> 04) & 0b0000111100001111000011110000111100001111000011110000111100001111) | ((x & 0b0000111100001111000011110000111100001111000011110000111100001111) << 04)
        x = ((x >> 02) & 0b0011001100110011001100110011001100110011001100110011001100110011) | ((x & 0b0011001100110011001100110011001100110011001100110011001100110011) << 02)
        x = ((x >> 01) & 0b0101010101010101010101010101010101010101010101010101010101010101) | ((x & 0b0101010101010101010101010101010101010101010101010101010101010101) << 01)
        return x >> (64 - k)
    end
end
